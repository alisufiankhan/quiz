...
function scoreRender() {
    ...
    scoreDiv.innerHTML = `<p>Your Score: ${score} / ${questions.length}</p>`;
    scoreDiv.innerHTML += `<p class="nxtbtn" style="font-size: 1.3rem;"><a href="./secondsection/index.html">Next</a></p>`;
